...
namespace AxeWindowsCLI
{
    public class Options : IOptions
    {
        ...
        [Option(Required = false, HelpText = "The full path to an assembly that exposes a public implementation of the IBitmapCreator interface for use with this scan.")]
